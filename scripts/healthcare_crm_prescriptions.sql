...
CREATE TABLE `prescriptions` (
  ...
  KEY `idx_prescriptions_patient_doctor` (`patient_id`,`doctor_id`),
  ...
  CONSTRAINT `prescriptions_ibfk_3` FOREIGN KEY (`medication_id`) REFERENCES `medications` (`medication_id`) ON DELETE CASCADE
